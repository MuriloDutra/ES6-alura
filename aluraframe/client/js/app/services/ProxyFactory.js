...
var ProxyFactory = function () {
    ...
    _createClass(ProxyFactory, null, [{
        ...
        value: function create(objeto, props, acao) {
            return new Proxy(objeto, {
                get: function get(target, prop, receiver) {
                    if (props.includes(prop) && ProxyFactory._verificaSeEFuncao(target[prop])) {
                        return function () {
                            ...
                            var retorno = Reflect.apply(target[prop], target, arguments); //Possível retorno
                ...
                set: function set(target, prop, value, receiver) {
                    var retorno = Reflect.set(target, prop, value, receiver); //Possível retorno
        ...
        key: "_verificaSeEFuncao",
        value: function _verificaSeEFuncao(func) {
